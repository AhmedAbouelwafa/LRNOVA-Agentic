...
export class AgentSelectorComponent {
  ...
  tools = [
    ...
    { 
      id: 'Text Video', label: 'Text\nVideo', desc: 'Convert text to a video lesson',
    ...
    { 
      id: 'Full Course Script', label: 'Course\nScript', desc: 'Generate a full course script',
    ...
    { 
      id: 'Full Course Content', label: 'Course\nContent', desc: 'Generate full course content',
      icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 12 12 17 22 12"></polyline><polyline points="2 17 12 22 22 17"></polyline></svg>'
    }
  ];
